...
* **Materi Pokok**   : Himpunan dan Sistem Bilangan
* **Tujuan Belajar** : Murid Mampu mengkonversi sistem bilangan decimal ke biner decimal ke oktal desimasl ke heksadesimal dan sebaliknya 
* **Nama Guru**      : Edy Santoso, S.Pd.
* **Nama Sekolah**   : SMP Negeri 1 Lamongan
* **File Logo**      : logo-sekolah.png
* **File Foto Guru** : foto-guru.jpeg
